...
const CharityListItem: FC<CharityListItemProps> = ({ charity }) => {
  return (
    <div className="border-2 border-lime-100 shadow-lg rounded-lg flex flex-col">
      <div className="shrink-0 bg-lime-100 p-2 flex space-x-2 items-center">
      ...
      <div className="grow p-2 space-y-2 flex flex-col">
        ...
        <div className="grow flex">
          <button className="flex mt-auto ml-auto w-min align-right items-center justify-end space-x-1 rounded-full bg-lime-200 px-2">
